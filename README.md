...
4. **Запуск через GitHub Pages**:
    ...
    Если вы не хотите загружать проект на свой локальный компьютер, вы можете запустить игру прямо из браузера, воспользовавшись [GitHub Pages](https://funskrip.github.io/hangman-game). Для этого:
...
## Ссылки
- [GitHub репозиторий](https://github.com/FunSkrip/hangman-game)
- [GitHub Pages](https://funskrip.github.io/hangman-game)